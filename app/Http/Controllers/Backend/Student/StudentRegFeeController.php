...
class StudentRegFeeController extends Controller
{
    public function view()
    {
        ...
        return view('backend.student.reg_fee.view',compact('years','classes'));
    }
    public function getStudent(Request $request)
    {
      ...
      foreach ( $allStudent as $key => $v){
          $registrationFee = FeeCategoryAmmount::where('fee_category_id','1')-> where('class_id', $v->class_id)->first();
          $color = 'success';
