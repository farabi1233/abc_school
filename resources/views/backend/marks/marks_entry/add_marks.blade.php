            ...
            <div class="card">
              <div class="card-header">
                <h3>  <i class="fas fa-search"></i> Search Criteria
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('marks.store') }}" id="marksForm" name="marksForm">@csrf
                        <div class="form-row">
                        ...
                        <div class="col-12 col-md-3 col-sm-3">
                            <div class="form-group" style="margin-top: 37px">
                                <button  class="btn btn-dark" name="searchMarksEntry" id="searchMarksEntry"> <i class="fas fa-search-plus"></i> Search</button>
                            </div>
                        </div>
                        </div>
