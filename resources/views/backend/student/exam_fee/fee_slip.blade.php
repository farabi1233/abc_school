@php
   $examFee = App\Model\FeeCategoryAmmount::where(['fee_category_id'=>'3','class_id'=>$details->class_id])->first();
            $originalFee = $examFee->amount;
            $discount = $details['discount']['discount'];
            $discountTableFee = $discount/100*$originalFee;
            $finalFee = (int)$originalFee-(int)$discountTableFee;
            $exam_type = App\Model\ExamType::where('id',$exam_type_id)->first();
@endphp
